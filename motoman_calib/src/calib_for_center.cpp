...
public:
  ...
  this->getMesh(ros::package::getPath("dhand_description")+"/meshes/collision/base.STL", "dhand_base_link");
    ...
    kinect_subscriber_ = nh_.subscribe<sensor_msgs::PointCloud2>("/kinect_center/qhd/points", 10, boost::bind(&MotomanMeshCloud::pointCloudCallback, this, _1));
...
{
  ros::init(argc, argv, "motoman_calib_center");
